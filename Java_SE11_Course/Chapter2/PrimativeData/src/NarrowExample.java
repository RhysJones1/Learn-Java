...
Sub-Topic: Narrowing
It's important to ensure you are using the correct data type. Narrowing will usually give you are
compiling error as you will lose data. Likewise, it's important not to widen as you are unnecessarily
storing additional data which for large programs could lead to issues.
*/
