...
You can cast to a large sized variable (widening), this poses less risk since there is
no risk of data loss. You can also do the opposite and cast to a smaller sized variable
however you can run the risk of data loss. In cases of the former, it's likely that
you know that the value won't exceed the tolerance at any point

Both are not ideal as it can lead to underflowing and overflowing
Underflowing: defining or casting a value less than the minimum value for the datatype
Overflowing: defining or casting a value greater than the maximum value for the datatype
*/
