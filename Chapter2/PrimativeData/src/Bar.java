...
/*
To use primitive data types in code you must initialise it as we saw within the
Foo2 Class.

This is not true for class static variable and instance variables which will have
