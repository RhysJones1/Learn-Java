...
//For local variables the compiler demands that you initialise your
//local variables fully before using them in code and doesn't assign any
//values to them. This is illustrated below
public class Bar2 {
